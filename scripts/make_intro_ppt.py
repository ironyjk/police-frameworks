...
s = prs.slides.add_slide(blank)
set_background(s, BG)
add_title_bar(s, "17개 공구, 4개 서랍", "상황에 맞게 골라 쓰는 공구함")

drawers = [
    ("문제 분석 · 예방",
     ["SARA", "삼각형", "SCP", "CPTED", "핫스팟", "ILP", "반복피해"],
     "반복 민원·핫스팟·환경 개선·기회 차단·반복 피해자 보호",
     NAVY),
    ("조사 · 면담 · 피해자",
     ["PEACE", "인지면담", "트라우마"],
     "비강압 면담·기억 인출·2차 가해 방지",
     NAVY_LIGHT),
    ("현장 위기 대응",
     ["BCSM", "ICAT"],
     ...
     RED),
    ("지역 · 정당성 · 회복",
     ["절차적정의", "COP", "회복적", "제3자", "깨진유리창"],
     "민원 응대·주민 협력·화해·제3자 개입·단속 함정",
     GOLD),
]

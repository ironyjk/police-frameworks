...
> **주의**: 이 도구는 AI 전문가(경주경찰서 경찰발전협의회 회원 최희철)가 제작한 **참고 자료**입니다. 경찰발전협의회는 봉사단체이며, 이 도구 역시 경발협 자체 활동 도구가 아니라 경찰 실무자에게 드리는 참고용입니다. 실제 분석·판단·개입은 경찰 고유의 권한이며, 이 라우터 출력은 경찰의 의사결정을 대체하지 않습니다.
